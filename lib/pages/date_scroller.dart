...
class _CalendarSlideshowState extends State<CalendarSlideshow> {
  ...
  void initState() {
    ...
    int todayIndex = 69;
    _scrollController = ScrollController(initialScrollOffset: todayIndex * 48.0);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_monthYearFormat.format(_selectedDate)), //Appbar som har valda datums månad o år
        centerTitle: true,
        backgroundColor: Color.fromRGBO(255, 0, 0, 0.929), 
      ),
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: List.generate(
          ...
          (index) {
            DateTime currentDate = _selectedDate.add(Duration(days: index - 60));
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? Color.fromARGB(255, 255, 0, 0) : Colors.transparent, //valda datum boxen
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                ...
                color: isSelected ? Colors.white : (isToday ? Colors.red : Colors.black), //valda datum text
            ...
            Text(
              ...
              date.day.toString(),
              style: TextStyle(
                color: isSelected ? Colors.white : (isToday ? Colors.red : Colors.black), //dagens datum fast färg
